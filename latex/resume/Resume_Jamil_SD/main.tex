...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Md Jamil Ahmed

        \vspace{5 pt}

        \normalsize
        \mbox{Toronto, Ontario, Canada}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        ...
        \kern 5.0 pt% 
        \\
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/md-jamil-ahmed-545164247}{linkedin.com/in/md-jamil-ahmed-545164247}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/jamil2388}{github.com/jamil2388}} \\
