...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Jamil Ahmed

        \vspace{5 pt}

        \normalsize
        \mbox{Toronto, ON, Canada, M3N 2M2}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:jamil.cse.2388@gmail.com}{jamil.cse.2388@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+1 437 662 8248}{(+1) 437-662-8248}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt% 
        \\
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/md-jamil-ahmed-545164247}{https://linkedin.com/in/md-jamil-ahmed-545164247}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/jamil2388}{https://github.com/jamil2388}} \\
        % \mbox{Canadian Status : Postgraduate Open Work Permit}
    \end{header}
